 ...
 */
function buildRealOutbreakMarkerIcon(color: string): L.DivIcon {
  return L.divIcon({
...
export default function ThreatMap({ threats, selectedThreat, onSelectThreat, filterLevel, filterDisease, filterReal = 'all', filterDateRange = { start: null, end: null } }: ThreatMapProps) {
  ...
  }, [threats, selectedThreat, onSelectThreat, filterLevel, filterDisease, filterReal, filterDateRange]);
